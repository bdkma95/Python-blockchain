...
class Blockchain:
    ...
    Attributes:
        ...
        :hosting-node: The connected node (which runs the blockchain).
    """
    ...
    def load_data(self):
        ...
        try:
            with open('blockchain-{}.txt'.format(self.node_id), mode='r') as f:
                ...
                # We need to convert the loaded data because Transactions should
                updated_blockchain = []
...
# One requiered one (transaction_amount) and one optional one (last_transaction)
